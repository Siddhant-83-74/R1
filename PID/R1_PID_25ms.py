...
# Constants for the encoder pins
    ...
    def rpm_(self,count):
        self.rpmAcl=(self.count/self.ppr)*600*4 #formula for calculating rpm from no. of ticks given by encoder.
...
m1=Encoder_(22,26,2,3)#a,b,pwm,dir_
m2=Encoder_(20,21,4,5)
m3=Encoder_(18,19,7,10)
...
m1.Kp=1.7634
m1.Ki=0.59554 #at 16.0 V
m1.Kd=0.12321


m2.Kp=1.73462
m2.Ki=0.59502 #at 16.0 V
m2.Kd=0.7735

m3.Kp=1.7443
m3.Ki=0.65032 #at 16.0 V
m3.Kd=0.5467
